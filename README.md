...
- [x] Mention two parts of Express that you learned about this week.
      ...
      1. Express is a JS framework that sits on top of the Node server, similar to React, but for
      the backend.
      2. It adds support for things like routing and middleware.

- [x] Describe Middleware?

      Middleware are functions that perform tasks and extend the features of Express. You can handle logging or authentication with middleware.

- [x] Describe a Resource?
        
       A resource is accessible via a uniqie URL, potentially represented multiple ways and managed
      via HTTP methods.

- [x] What can the API return to help clients know if a request was successful?
        
       A response status of 200 or 201, as well as returning the sucess message or the succesful object which could contain a User ID for example.

- [x] How can we partition our application into sub-applications?
        
       We can use Express routes to break down different sub-applications to help things be organized via URL's.
